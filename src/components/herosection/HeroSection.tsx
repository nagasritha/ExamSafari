...
function HeroSection() {
  return (
    <div>
      <img className=" h-[600px] w-full animatedImage" src="/images/bannar3.png" alt="dummy-image" />
      <h2 className="absolute bottom-[550px] font left-[400px] md:text-5xl text-[#142d55] uppercase  font-semibold">travel your exam city with exam safari</h2>
