  ...
  return (
    <div className="px-2 md:px-0 card border border-md my-4  border-gray-300 rounded-lg flex flex-col md:flex-row w-full bg-white">
      ...
      <div className='img-part md:w-1/3 py-1'>
        <img className='w-full h-auto rounded-xl aspect-square' src={property.images[0]} alt={property.name} />
      </div>
      <div className='contant-Part md:mx-6 w-full md:w-2/3 mt-4 md:mt-0'>
        ...
        <div className="card-body">
          ...
          <ul>
            ...
            <li className='text-xs text-black py-1'>{`Amenities: ${property.amenities.join(', ')}`}</li>
            ...
            <div className='flex justify-between items-center py-2'>
              <li className='flex items-center'> <p className='text-xs'> "From"</p>
                <li>
                  <p className='font-semibold text-lg '>{`${property.price.from} ${property.price.status || ''}`}</p>
                </li>
              </li>
              <button className='bg-blue-500 py-1 text-white px-2 rounded-md font-semibold'>Enquire</button>
            </div>
