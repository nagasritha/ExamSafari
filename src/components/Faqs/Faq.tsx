  ...
  return (
    <>
      <div id="#contact-section" className='services-container'>
        <div className='service-heading mt-36' style={{textAlign:"center"}}> {data.homeData.faqHeading}</div>
        <div className='service-para mb-16' style={{textAlign:"center"}}> {data.homeData.faqDescription} </div>
