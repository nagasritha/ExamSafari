...
const ThankyouModal:React.FC<ThankyouModalProps>=({closeThankyou,failure})=>{
  console.log(failure)
  console.log("thank you page");
    return <div className="thankyou-popup custom-modal-padding">
      ...
      <p className='pt-3 text-2xl text-black'>{failure ? <b>Sorry!</b>:<b>Hurrey!</b>}</p>
       <h3 className="pt-3 text-2xl text-black">{failure ? <p>Failed to submit the Details</p>:<p>Form Submited Successfully</p>}</h3>
