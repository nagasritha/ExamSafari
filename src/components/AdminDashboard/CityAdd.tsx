...
const CityAdd = () => {
    return (
      <div className="px-10 h-screen pt-2">
       ...
       <div className="text-xl font-semibold pb-4 text-blue-700 ">Add City</div>
  
        <form action="">
        <div className="mb-5">
        <label  className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name of City</label>
  ...
  <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white" >Upload picture of City</label>
  ...
  <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add another City</button>
  </div>
