...
<div className="py-16">
    <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        <div className="hidden lg:block lg:w-1/2 bg-cover bgImage"
            >
        </div>
        <div className="w-full p-8 lg:w-1/2">
            <h2 className="text-2xl font-semibold text-gray-700 text-center">Exam Safari!</h2>
            ...
            <div className="mt-4 flex items-center justify-between">
                ...
                <a href="#" className="text-xs text-center text-gray-500 uppercase">or login with Phone Number</a>
                <span className="border-b w-1/5 lg:w-1/4"></span>
            </div>
            <div className="mt-4">
            ...
            <div className="mt-4">
                <div className="flex justify-between">
                    ...
                    <a href="#" className="text-xs text-gray-500">Send OTP</a>
                </div>
